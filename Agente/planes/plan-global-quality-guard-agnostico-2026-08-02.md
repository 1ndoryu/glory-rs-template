...
> **Fecha:** 2026-08-02
> **Estado:** migración incremental en ejecución; el contrato local v2 y `doctor --migrate --dry-run` están implementados. La instalación global quedó autorizada y ejecutada (2026-08-05), la matriz multi-proyecto/multi-shell está cerrada (Fase 4, 2026-08-05) y los artifacts CI con branch-key+task+commit quedaron publicados (Fase 4 residual, 2026-08-05). De la Fase 5 están cerrados el PATH legacy retirado y el comando `sentinel uninstall` (desinstalación solo de entradas administradas) con rollback documentado; quedan la retirada de los wrappers del repo (exige dos releases consecutivos con rollback probado) y la marcación legacy del guard actual.
>
