...
- [ ] Mantener lectura de los formatos anteriores durante dos versiones de runtime, con warning visible y fecha de retirada. El preview local legacy ya conserva las fuentes sin escritura; falta definir el warning/retirada del runtime global.
