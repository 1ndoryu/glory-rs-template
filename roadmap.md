...
**Petición del usuario (2026-08-05):** «veo que no está implementado algo para seleccionar varios objetos en el escritorio y explorador con el mouse, debería ser posible como en windows». Plan activo: `Agente/planes/plan-seleccion-multiple-2026-08-05.md`.

- [ ] Cablear Ctrl/Shift+clic (toggleSelect/extendSelect) en grid del escritorio y Finder
- [ ] Rubber band (arrastrar rectángulo desde el fondo) en escritorio y Finder
- [ ] Drag de grupo (mover todos los seleccionados) y menú contextual sobre multi-selección
- [ ] Comandos multi: trash borra todos los targets; open/rename solo con selección simple
- [ ] Refactor de rendimiento: el Finder no re-renderiza todo el grid al cambiar la selección (aplica clases a ítems existentes)
- [ ] Tests (intersección de la banda + regresión comandos), type-check, navegador desktop y móvil
- [ ] Gate + commit + push

**Criterio de salida:** clic simple selecciona; Ctrl+clic suma/resta; Shift+clic extiende rango; banda de selección desde el fondo con feedback provisional; clic derecho sobre multi-selección abre el menú con todas las acciones multi (copiar/cortar/eliminar); arrastrar un ítem seleccionado mueve todo el grupo; sin regresión en móvil (<768) ni en doble clic del Finder.
