 ...
 * las apps Bosque; este fallback solo aporta esas entradas visuales en DEV.
...
const LOCAL_PROTOTYPE_NODE_IDS = ['game', 'game3d', 'gamePlayable'] as const;

/**
 * Añade únicamente los nodos del boceto que todavía no conoce el release
 * local. No sobrescribe posiciones, etiquetas ni nodos publicados; los
 * tombstones del overlay siguen prevaleciendo en mergeWorkspace. El fixture
 * jugable se incluye solo como compatibilidad local mientras el release
 * publicado no lo conozca. [GAME-01-F3]
 */
