...
export const ADMIN_NODES: Record<string, WorkspaceNode> = {
  settings: {
    ...
    position: { col: 0, row: 4 }, mobileOrder: 4, requires: 'admin',
  },
  admin: {
    id: 'admin', parentId: 'desktop', type: 'app', label: 'Admin', refId: 'admin',
    position: { col: 0, row: 5 }, mobileOrder: 5, requires: 'admin',
  },
};
