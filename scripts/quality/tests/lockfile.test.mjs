...
const manifest = {
  ...
  tools: {
    sentinel: { version: '0.4.0', outputSchemaVersion: '1', commit: 'a'.repeat(40) },
...
function validLock() {
  ...
  return {
    ...
    runtime,
    analyzers: {
      sentinel: { version: '0.4.0', protocolVersion: 1, commit: 'a'.repeat(40), sha256: 'c'.repeat(64) },
      varsense: { version: '2.2.0', protocolVersion: 1, commit: 'b'.repeat(40), sha256: 'd'.repeat(64) },
    },
  };
}
